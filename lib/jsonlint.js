...
var jsonlint = (function() {
	var parser = {
		...
		callback: function(str, hash) {
			throw new Error(str);
		},
		parse: function parse (input, callback) {
		...
		var lexer = ({
			...
			next: function() {
				...
				if (this._input === "") {
					...
					this.callback('Lexical error on line ' + (this.yylineno + 1) + '. Unrecognized text.\n' + this.showPosition(),
